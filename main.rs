...
mod tests {
    ...
    fn test_nodes_with_extreme_degrees() {
        // Create an instance of your AmazonNetwork
        let mut amazon_network = AmazonNetwork::new();

        // Add nodes and edges to the graph (you can adjust this for your test case)
        let nodes = vec![
            (1, 2),
            (1, 3),
            (2, 3),
        ...
        // Expected result for the provided test case (adjust as needed)
        let expected_result = Some((NodeIndex::new(0), NodeIndex::new(2)));

        // Check if the method output matches the expected result
